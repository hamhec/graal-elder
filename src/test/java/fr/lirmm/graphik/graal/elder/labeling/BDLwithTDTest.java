...
public class BDLwithTDTest extends KnowledgeBaseForLabelingTesting {
	...
	public static void setupSG() throws IteratorException, ChaseException, AtomSetException, HomomorphismException {
		sg = new StatementGraph(kb, new BDLwithTD(kb));
		sg.build();
	}
	...
	// ------------------------------------------------------------------------
	@Test
	public void shouldBeAmbiguityBlockingWithTeamDefeat() throws IteratorException, AtomSetException {

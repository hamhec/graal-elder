...
public class BDLwithoutTDTest extends KnowledgeBaseForLabelingTesting {
	...
	public static void setupSG() throws IteratorException, ChaseException, AtomSetException, HomomorphismException {
		sg = new StatementGraph(kb, new PDLwithoutTD(kb));
		sg.build();
	}
	...
	// ------------------------------------------------------------------------
	@Test
	public void shouldBeAmbiguityPropagatingWithoutTeamDefeat() throws IteratorException, AtomSetException {

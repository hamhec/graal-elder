...
public class PDLwithoutTDTest extends KnowledgeBaseForLabelingTesting {
	...
	public static void setupSG() throws IteratorException, ChaseException, AtomSetException, HomomorphismException {
		sg = new StatementGraph(kb, new BDLwithoutTD(kb.getRulePreferences()));
		sg.build();
	}
	...
	// ------------------------------------------------------------------------
	@Test
	public void shouldBeAmbiguityBlockingWithoutTeamDefeat() throws IteratorException, AtomSetException {
